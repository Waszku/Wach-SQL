...
SELECT SUM(Annual_Income_Tax) as podatki_w_teksasie FROM Companies WHERE HQ_State = 'Texas'  !TO DO


---12. By what percentage did Amazon have more annual revenue than Apple?       !TO DO !
...
---13. Which companies have more employees than the average number of employees for all companies in the table?  !TO DO!
